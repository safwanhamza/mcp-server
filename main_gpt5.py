    ...
    try:
        for i, text in enumerate(chunks, start=1):
            ...
            try:
                ...
                gemini_prompt_text = call_gpt5_for_upscale_prompt(gpt_system_for_prompt, filled_user_prompt, [a_s3 or anchor_a_path, b_s3 or anchor_b_path])
                ...
                for attempt in range(1, MAX_GEMINI_RETRIES + 1):
                    ...
                    if gemini_upscale_image(anchor_b_path, upscaled_path, gemini_prompt_text):
                        ...
                        similarity = call_gpt5_for_similarity_check(gpt_system_for_check, gpt_user_for_check, last_upscaled_s3_url or upscaled_path, b_s3 or anchor_b_path)
